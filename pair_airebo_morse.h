...
PairStyle(airebo_morse,PairAIREBO_MORSE)
...
class PairAIREBO_MORSE : public Pair {
 public:
  PairAIREBO_MORSE(class LAMMPS *);
  virtual ~PairAIREBO_MORSE();
 ...
 protected:
  ...
  int me;
  int covflag,ljflag,torflag, reboflag;              // 0/1 if LJ,torsion,rebo terms included
